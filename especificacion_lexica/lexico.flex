...
"<="            {	if(debug) System.out.println("token MENEQ");
			return sf.newSymbol("MENEQ",sym.MENEQ);
			}
">="            {	if(debug) System.out.println("token MAYEQ");
			return sf.newSymbol("MAYEQ",sym.MAYEQ);
			}
...
{real}          {	if(debug) System.out.println("token REAL");
			return sf.newSymbol("REAL",sym.REAL,new Integer(yytext()));
			}
